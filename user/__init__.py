...
from user.controller.v1 import user_controller, credential_controller
...
__keywords__ = ''
__repo_name__ = 'User Service'
__description__ = 'User Service for Guya'
__project_name__ = 'User Service'
